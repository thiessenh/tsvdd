...
class svm_model(Structure):
	...
	def get_r2(self):
		return libsvm.svm_get_r2(self)

	def get_rho(self):
		return libsvm.svm_get_rho(self)
...
fillprototype(libsvm.svm_get_r2, c_double, [POINTER(svm_model)])
fillprototype(libsvm.svm_get_rho, c_double, [POINTER(svm_model)])
fillprototype(libsvm.svm_predict_values, c_double, [POINTER(svm_model), POINTER(svm_node), POINTER(c_double), c_double])
